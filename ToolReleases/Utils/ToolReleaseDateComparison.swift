...
enum ToolReleaseDateComparison {
    ...
    static func isTool(_ tool: Tool, releasedLessThan value: Int, _ component: Calendar.Component) -> Bool {
        let calendar = Calendar.current
        let components = calendar.dateComponents([component], from: .now, to: tool.date)
